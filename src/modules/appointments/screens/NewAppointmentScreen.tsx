...
type NewAppointmentScreenProps = {
  navigation: StackNavigationProp<RootStackParamList, 'NewAppointment'>;
};

const NewAppointmentScreen: React.FC<NewAppointmentScreenProps> = ({ navigation }) => {
